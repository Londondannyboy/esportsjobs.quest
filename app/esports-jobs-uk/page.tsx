...
export const metadata: Metadata = {
  title: "Esports Jobs UK | Find Gaming Careers 2025 | EsportsJobs.quest",
  description:
    "Discover 500+ esports jobs in the UK. From entry-level to senior roles in gaming organisations. Browse competitive salaries, remote positions & apply today.",
  keywords:
    "esports jobs uk, esports careers uk, gaming jobs uk, esports employment, competitive gaming jobs, esports industry jobs uk",
  openGraph: {
    title: "Esports Jobs UK | Find Gaming Careers 2025",
    description:
      "Discover 500+ esports jobs in the UK. From entry-level to senior roles in gaming organisations.",
    type: "website",
...
const faqs = [
  {
    question: "How do I get an esports job in the UK with no experience?",
    answer: "Start by building experience through university esports, volunteering at local tournaments, creating content, or joining amateur teams. Many UK esports organisations offer internships and entry-level roles. Focus on developing transferable skills like project management, video editing, or data analysis alongside your gaming knowledge.",
  },
  {
    question: "What qualifications do I need for esports jobs in the UK?",
    answer: "While traditional qualifications aren't always required, relevant degrees in sports science, marketing, business, or media production can help. Several UK universities now offer esports-specific courses. Most importantly, demonstrate your passion through practical experience, whether that's coaching amateur teams, creating content, or organising tournaments.",
  },
  {
    question: "What is the average esports salary in the UK?",
    answer: "UK esports salaries vary significantly by role and experience. Entry-level positions typically start at £22,000-£28,000, mid-level roles range from £35,000-£45,000, and senior positions can exceed £60,000-£100,000+. Coaches at top organisations and successful content creators often earn considerably more.",
  },
  {
    question: "Are there remote esports jobs available in the UK?",
    answer: "Yes, many esports roles can be done remotely, especially in content creation, analytics, marketing, and coaching. The industry embraced remote work significantly, with many UK and international organisations offering flexible or fully remote positions. Check our remote esports jobs page for current opportunities.",
  },
  {
    question: "Which UK cities have the most esports jobs?",
    answer: "London has the highest concentration of esports jobs in the UK, home to organisations like Fnatic, Excel Esports, and Gfinity. Manchester, Birmingham, and Sheffield also have growing esports scenes. Many roles are also available remotely, opening opportunities regardless of location.",
  },
  {
    question: "What skills are most in demand for UK esports jobs?",
    answer: "Top skills include: data analysis and performance tracking, video editing and content creation, social media and digital marketing, event management and production, strategic coaching and game knowledge, business development and partnerships. Technical skills in tools like OBS, Premier Pro, and analytics platforms are highly valued.",
  },
  {
    question: "How competitive is the UK esports job market?",
    answer: "The UK esports job market is competitive but growing rapidly. According to Ukie, the UK games industry employs over 20,000 people with esports being one of the fastest-growing sectors. Standing out requires a combination of gaming knowledge, professional skills, and demonstrable experience through content, volunteering, or amateur involvement.",
  },
  {
    question: "Do UK esports organisations hire internationally?",
    answer: "Yes, many UK esports organisations hire internationally, especially for remote roles. However, for on-site positions, you may need the right to work in the UK. Post-Brexit, international candidates typically need visa sponsorship. Some organisations specifically recruit from the EU and beyond for specialised roles.",
  },
];
            ...
            <div className="max-w-4xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                  ...
                  <div className="text-sm text-slate-400">Active UK Roles</div>
                </div>
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                  <div className="text-3xl font-bold text-cyan-400">50+</div>
                  <div className="text-sm text-slate-400">UK Organisations</div>
                </div>
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
