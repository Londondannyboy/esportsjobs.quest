...
export const metadata: Metadata = {
  title: "Esports Careers | Your Complete Pathway Guide 2025 | EsportsJobs.quest",
  description:
    "Explore all esports career paths from coaching to broadcasting, marketing to management. Complete guide to building your esports career with salary info & requirements.",
  keywords:
    "esports careers, esports career paths, how to work in esports, esports professions, esports job guide, competitive gaming careers",
  openGraph: {
    title: "Esports Careers | Your Complete Pathway Guide 2025",
    description: "Explore all esports career paths from coaching to broadcasting, marketing to management.",
    type: "website",
...
const faqs = [
  {
    question: "What esports careers don't require being a pro player?",
    answer: "The vast majority of esports careers don't involve playing professionally. Coaching, analysis, marketing, content creation, broadcasting, event management, business development, and operations roles are all viable careers without pro gaming experience. In fact, these roles often require different skill sets entirely—business acumen, communication skills, or technical production knowledge.",
  },
  {
    question: "Which esports career path has the best salary potential?",
    answer: "Business development, senior marketing, and executive roles typically offer the highest salaries (£70,000-£150,000+). However, successful content creators can earn significantly more through sponsorships and revenue sharing. Coaches at top organisations also command premium salaries. The key is reaching senior levels in any path or building significant audience reach as a creator.",
  },
  {
    question: "Can I switch from traditional sports to esports?",
    answer: "Absolutely. Many skills transfer directly: coaching methodology, sports psychology, event management, marketing, and operations. The main adjustment is learning the specific games, culture, and digital-first nature of esports. Traditional sports professionals are increasingly valued for the professionalism and structure they bring to esports organisations.",
  },
  {
    question: "How long does it take to build an esports career?",
    answer: "Entry-level roles can be achieved within 1-2 years of focused effort—building skills, creating a portfolio, and networking. Reaching senior positions typically takes 5-10 years of industry experience. Content creators may build careers faster with viral success, while coaching often requires years of competitive experience and credibility building.",
  },
  {
    question: "Is a degree necessary for esports careers?",
    answer: "Not always. Many successful esports professionals don't have degrees, especially in content, coaching, and operations. However, degrees are beneficial for marketing, business, education, and psychology roles. What matters most is demonstrable skills, practical experience, and passion. A portfolio of work often outweighs academic credentials.",
  },
  {
    question: "Which esports career is best for beginners?",
    answer: "Common entry points include: tournament administration (volunteer at events), community management (engage in Discord communities), content creation (start creating and building an audience), and coaching (start with amateur teams). QA testing at game companies is another pathway. The key is starting somewhere and building from there.",
  },
  {
    question: "Are esports careers stable long-term?",
    answer: "The esports industry continues to grow, with increasing investment and professionalisation. While individual organisations may face challenges, the overall industry trajectory is positive. Skills developed in esports—digital marketing, content creation, event management—are transferable to other industries. Building diverse skills creates career resilience.",
  },
  {
    question: "How do I know which esports career is right for me?",
    answer: "Consider your existing skills and interests: Are you analytical (analyst), creative (content), organised (operations), or persuasive (marketing)? Do you enjoy working with people (coaching, community) or prefer behind-the-scenes (production)? Try multiple areas through volunteering and personal projects to discover what resonates before committing to a path.",
  },
];
