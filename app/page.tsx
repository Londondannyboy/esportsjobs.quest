          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">
                Planning an esports event? Compare <a href="https://esportsevent.quest" className="text-cyan-400 hover:underline">esports event insurance</a> quotes and protect your tournament or gaming venue.
              </p>
              <span className="text-cyan-400 text-sm font-medium">
                Get Esports Insurance →
              </span>
            </a>
            <a
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">
                Need broadcast services? Our <a href="https://esportsproduction.quest" className="text-purple-400 hover:underline">esports production agency</a> delivers world-class <a href="https://esportsproduction.quest" className="text-purple-400 hover:underline">esports production company</a> services.
              </p>
              <span className="text-purple-400 text-sm font-medium">
                Hire Esports Production →
              </span>
            </a>
            <a
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">
                Stay informed with the latest <a href="https://esportsnews.quest" className="text-green-400 hover:underline">esports news</a>, industry updates, and career advice for gaming professionals.
              </p>
