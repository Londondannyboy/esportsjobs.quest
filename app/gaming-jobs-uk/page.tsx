...
export const metadata: Metadata = {
  title: "Gaming Jobs UK | Find Your Dream Role 2025 | EsportsJobs.quest",
  description:
    "Discover gaming jobs across the UK in game development, QA testing, esports, streaming & more. Browse 1000+ roles at top UK gaming companies. Apply today.",
  keywords:
    "gaming jobs uk, gaming industry jobs, game developer jobs uk, gaming careers uk, video game jobs uk, gaming employment uk",
  openGraph: {
    title: "Gaming Jobs UK | Find Your Dream Role 2025",
    description:
      "Discover gaming jobs across the UK in game development, QA testing, esports & more.",
    type: "website",
...
const faqs = [
  {
    question: "What qualifications do I need for gaming jobs in the UK?",
    answer: "Requirements vary by role. Developers typically need programming skills (C++, C#, Unity, Unreal), often with a computer science degree. Artists need strong portfolios demonstrating 2D/3D skills. QA roles are often entry-level requiring attention to detail. Business roles value relevant degrees and experience. Passion and a strong portfolio often matter more than formal qualifications.",
  },
  {
    question: "How do I get into the gaming industry with no experience?",
    answer: "Start by building a portfolio through personal projects, game jams, and modding. QA testing is a common entry point with lower barriers. Internships and graduate schemes at major studios are excellent pathways. Networking at events like EGX and through online communities opens doors. Consider freelance work to build experience and contacts.",
  },
  {
    question: "What is the average gaming industry salary in the UK?",
    answer: "According to TIGA and Ukie industry reports, average UK games industry salaries range from £22,000 for QA testers to £85,000+ for senior programmers and lead designers. London salaries are typically 15-20% higher. Studio leads and directors can earn £100,000+. The industry average across all roles is approximately £40,000-£50,000.",
  },
  {
    question: "Are there remote gaming jobs in the UK?",
    answer: "Yes, remote and hybrid working has become common in the UK gaming industry, especially post-pandemic. Many studios offer flexible arrangements. Roles like game design, programming, art, and QA can often be done remotely. However, some studios prefer on-site presence for collaborative work, particularly in senior or leadership roles.",
  },
  {
    question: "What are the best cities for gaming jobs in the UK?",
    answer: "London has the most gaming jobs, followed by Leamington Spa (Silicon Spa), Guildford, Edinburgh, Brighton, and Dundee. Each has unique strengths—London for publishing and esports, Leamington for racing games, Edinburgh for AAA development, Brighton for indie studios. Remote work has also opened opportunities regardless of location.",
  },
  {
    question: "How competitive is the UK gaming job market?",
    answer: "The UK gaming job market is competitive, particularly for development and creative roles. However, the industry employs over 20,000 people and is growing. Studios often struggle to fill senior programming and technical art positions. QA roles have more competition at entry level. Standing out requires a strong portfolio and relevant skills.",
  },
];
